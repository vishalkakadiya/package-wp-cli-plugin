...
git clone git@github.com:vishalkakadiya/package-wp-cli-plugin.git

node /PATH_TO_CLONNED_DIRECTORY/package-wp-cli-plugin/bin/package-wp-cli-plugin.js package-wp-cli-plugin

# Pass the slug upfront to skip the first prompt
node /PATH_TO_CLONNED_DIRECTORY/package-wp-cli-plugin/bin/package-wp-cli-plugin.js my-awesome-plugin
```
